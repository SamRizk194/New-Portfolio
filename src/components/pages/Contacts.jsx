      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="mb-16 md:mb-20 flex flex-col items-center md:items-start">
          ...
          <p className="mt-6 text-lg md:text-xl text-zinc-400 max-w-2xl text-center md:text-left leading-relaxed">
            Got a wild idea or a serious project? Drop a message. I'm available for freelance work.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
            ...
            >
              ...
              <div className="flex justify-between items-start z-10">
                <div className="p-3 bg-white/5 rounded-xl border border-white/10 group-hover:scale-110 transition-transform duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#4ade80]">
                    <path d="M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719" />
                  </svg>
                </div>

                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-600 group-hover:text-[#4ade80] group-hover:translate-x-1 group-hover:-translate-y-1 transition-all duration-300">
                  <path d="M7 7h10v10" />
                  <path d="M7 17 17 7" />
                </svg>
              </div>
          ...
          <div className="lg:col-span-7">
            ...
            <form className="relative h-full flex flex-col justify-between bg-zinc-950/80 backdrop-blur-2xl p-8 md:p-10 rounded-[32px] border border-white/10 shadow-2xl">
