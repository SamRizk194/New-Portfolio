...
const ProjectCard = ({ project }) => {
  ...
  if (isHighlighted) {
    return (
      <div className="relative group w-full max-w-full sm:max-w-sm bg-zinc-950 rounded-[24px] overflow-hidden shadow-lg border border-white/5 transition-all duration-300 sm:hover:scale-[1.02] hover:border-[#4ade80]/30 hover:shadow-[0_0_30px_rgba(74,222,128,0.05)] font-[belanosima]">
        {/* IMAGE */}
        <div className="relative w-full h-52 sm:h-64 overflow-hidden bg-black">
          <div className="absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-[#4ade80] to-transparent opacity-50" />
